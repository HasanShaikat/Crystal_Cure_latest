      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-4">
            <div className="my-auto">
                <img src="
                /images/crystal-cure-final-logo.png" alt="Footer Logo" className="w-28 mx-auto"/>
                <p className="text-center">Crystal Cure Pest Control</p>
            </div>
            <div className="grid gap-y-4"initial={{ opacity: 0, y: -100 }}
